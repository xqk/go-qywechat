...
// 否则为单纯的【发送应用消息】接口调用。
func (c *QyWechatApp) SendTextMessage(
	recipient *Recipient,
	content string,
	isSafe bool,
) error {
...
// 收件人参数如果仅设置了 `ChatID` 字段，则为【发送消息到群聊会话】接口调用；
// 否则为单纯的【发送应用消息】接口调用。
func (c *QyWechatApp) SendImageMessage(
	recipient *Recipient,
	mediaID string,
	isSafe bool,
) error {
...
// 收件人参数如果仅设置了 `ChatID` 字段，则为【发送消息到群聊会话】接口调用；
// 否则为单纯的【发送应用消息】接口调用。
func (c *QyWechatApp) SendVoiceMessage(
	recipient *Recipient,
	mediaID string,
	isSafe bool,
) error {
...
// 收件人参数如果仅设置了 `ChatID` 字段，则为【发送消息到群聊会话】接口调用；
// 否则为单纯的【发送应用消息】接口调用。
func (c *QyWechatApp) SendVideoMessage(
	recipient *Recipient,
	mediaID string,
	description string,
	title string,
...
// 收件人参数如果仅设置了 `ChatID` 字段，则为【发送消息到群聊会话】接口调用；
// 否则为单纯的【发送应用消息】接口调用。
func (c *QyWechatApp) SendFileMessage(
	recipient *Recipient,
	mediaID string,
	isSafe bool,
) error {
...
// 收件人参数如果仅设置了 `ChatID` 字段，则为【发送消息到群聊会话】接口调用；
// 否则为单纯的【发送应用消息】接口调用。
func (c *QyWechatApp) SendTextCardMessage(
	recipient *Recipient,
	title string,
	description string,
	url string,
...
// 收件人参数如果仅设置了 `ChatID` 字段，则为【发送消息到群聊会话】接口调用；
// 否则为单纯的【发送应用消息】接口调用。
func (c *QyWechatApp) SendNewsMessage(
	recipient *Recipient,
	articles []Article,
	isSafe bool,
) error {
...
// 收件人参数如果仅设置了 `ChatID` 字段，则为【发送消息到群聊会话】接口调用；
// 否则为单纯的【发送应用消息】接口调用。
func (c *QyWechatApp) SendMPNewsMessage(
	recipient *Recipient,
...
// 收件人参数如果仅设置了 `ChatID` 字段，则为【发送消息到群聊会话】接口调用；
// 否则为单纯的【发送应用消息】接口调用。
func (c *QyWechatApp) SendMarkdownMessage(
	recipient *Recipient,
	content string,
	isSafe bool,
) error {
...
func (c *QyWechatApp) SendTaskCardMessage(
	recipient *Recipient,
	title string,
	description string,
	url string,
...
func (c *QyWechatApp) SendTemplateCardMessage(
	recipient *Recipient,
...
// 否则为单纯的【发送应用消息】接口调用。
func (c *QyWechatApp) sendMessage(
	recipient *Recipient,
	msgtype string,
